...
const EventCategories = () => {
  ...
  const [data, getData, { loading }] = useFetch(GetAllEventCategories);
      ...
      <div className="w-full overflow-x-auto mt-7 dashboardModal">
        <div className="border-2 border-[#1c2c52] rounded">
          <div className="flex justify-between px-8 pt-8 items-center">
            <h1 className="text-[#C7D1DA] text-3xl">Event Category List</h1>
            <BackButton />
          </div>
          <Table
            columns={columns}
            ...
            onDelete={DeleteEventCategories}
            indexed
            langCode={langCode}
            pagination
          />
            ...
            title={
              isEdit ? (
                <h2 className="text-[#22F55D] heading-3">
                  {i18n.t("Edit Event Category")}
                </h2>
              ) : (
                <h2 className="text-[#22F55D] heading-3">
                  {i18n.t("Add New Event Category")}
                </h2>
              )
            }
            footer={null}
          ...
          >
            ...
            <Form
              ...
              onFinish={(values) => {
                ...
                return useAction(
                  isEdit ? UpdateEventCategories : CreateEventCategory,
                  {
                    body: {
                      ...formattedData,
                      _id: values?._id,
