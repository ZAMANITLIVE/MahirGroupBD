...
const EventCategories = () => {
  ...
  const [data, getData, { loading }] = useFetch(getAllProjectCategories);
      ...
      <div className="w-full overflow-x-auto mt-7 dashboardModal">
        <div className="border-2 border-[#1c2c52] rounded">
          <div className="flex justify-between px-8 pt-8 items-center">
            <h1 className="text-[#C7D1DA] text-3xl">{i18n.t("Product Categories")}</h1>
            <BackButton />
          </div>
          <Table
            columns={columns}
            ...
            onDelete={deleteProjectCategory}
            indexed
            langCode={langCode}
            pagination
          />
          ...
          >
            ...
            <Form
              ...
              onFinish={(values) => {
                ...
                return useAction(
                  isEdit ? updateProjectCategory : createProjectCategory,
                  {
                    body: {
                      ...formattedData,
                      _id: values?._id,
