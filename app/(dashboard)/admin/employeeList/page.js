  ...
  return (
    <div className="w-full overflow-x-auto mt-7 dashboardModal">
      <div className="border-2 border-[#1C2C52] rounded dashboardInput">
        ...
        {/* edit and add modal */}
        <Modal
          className="dashboardModal xl:!w-[700px] auth"
          open={openEditModal}
        ...
        >
          ...
          >
            ...
            <FormSelect
              ...
              name="role"
              label="Role"
              initialValue={employeeId ? data?.permissions?._id : ''}
        ...
        >
          {viewData && (
            <div className="mt-6 gap-8 px-5 md:px-6 py-2 md:py-3 lg:py-4 xl:py-5">
              <h5 className="text-[#22F55D] description-1 text-center">{i18n.t(`Details of ${viewData?.name}`)}</h5>
              <div className="mt-4">
                <div>
                  {
                    viewData?.images?.length > 0 && viewData?.images[0] ? (
                      ...
                      <CgProfile className="lg:text-8xl text-6xl mx-auto mb-2 text-[#8D97AD]" />
                  }
                </div>
                  ...
                  {[
                    ...
                    >
                      <div className="flex items-center gap-2 mt-4">
                        ...
                        <h3 className="text-sm capitalize font-semibold text-[#8D97AD]">
                          {i18n.t(item.label) || item.label}
                        </h3>
                      </div>
                      <h3 className="text-sm font-medium truncate mt-4 text-[#8D97AD]">
        ...
        <Modal
          ...
          footer={null}
        >
          <h1 className="description-1 text-primary !font-inter my-6">
