...
const CaseStudyCategories = () => {
  ...
  const [data, getData, { loading }] = useFetch(getAllCaseStudyCategories);
      ...
      <div className="w-full overflow-x-auto mt-7 dashboardModal">
        <div className="border-2 border-[#1c2c52] rounded">
          <div className="flex justify-between px-8 pt-8 items-center">
            <h1 className="text-[#C7D1DA] text-3xl">{i18n.t("Case Study Categories")}</h1>
            <BackButton />
          </div>
          <Table
            columns={columns}
            ...
            onDelete={deleteCaseStudyCategory}
            indexed
            langCode={langCode}
            pagination
          />
            ...
            title={
              isEdit ? (
                <h2 className="text-[#22F55D] heading-3">
                  {i18n.t("Edit Case Study Category")}
                </h2>
              ) : (
                <h2 className="text-[#22F55D] heading-3">
                  {i18n.t("Add New Case Study Category")}
                </h2>
              )
            }
            footer={null}
          ...
          >
            ...
            <Form
              ...
              onFinish={async (values) => {
                ...
                return useAction(
                  isEdit ? updateCaseStudyCategory : createCaseStudyCategory,
                  {
                    body: {
                      ...formattedData,
                      ...values,
