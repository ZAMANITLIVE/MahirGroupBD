  ...
  return (
    <div className="flex flex-wrap justify-between mb-2">
      { show && <div className="flex items-center !mb-6 md:!mb-0 ">
        {onSizeChange && (
          <div className="flex items-center mr-3 text-sm  text-[#C7D1DA] h-[24px]">
            {i18n?.t('Show')}
            <select
              value={limit}
              onChange={(e) => {
              ...
              className="h-[24px] px-1 rounded mx-2 text-center bg-[#1c2c52] focus:outline-0"
            >
        ...
        { show && <p className="text-sm text-[#C7D1DA]">
