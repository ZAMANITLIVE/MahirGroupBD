...
const visibleClients = [
  { name: 'Global Recycle', src: '/clients/global.jpeg' },
  { name: 'Oeko Tex', src: '/clients/oeko.png' },
];
...
export default function Certification() {
  return (
    <section className="w-full py-12 bg-[#FEF9E1] text-center">
      <h2 className="text-3xl font-semibold text-gray-800 mb-8">Award/Certification</h2>
